      ...
      <section className='py-12 bg-[#FAEDCD]' dir={dir}>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center'>
            <h1 className='text-3xl md:text-4xl font-bold text-[#5C4033] mb-6'>{t('about')}</h1>
      ...
      <section className='py-12 bg-white' dir={dir}>
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div>
              <h2 className='text-2xl font-bold text-[#5C4033] mb-4'>{t('aboutTitle')}</h2>
              <p className='text-gray-800 mb-4'>{t('aboutDescription1')}</p>
              <p className='text-gray-800 mb-4'>{t('aboutDescription2')}</p>
              <p className='text-gray-800 mb-4'>{t('aboutDescription3')}</p>
