...
export default function LegalPage() {
  ...
  const legalContent = {
    es: (
      <>
        <h2 className='text-xl font-bold mb-4 text-[#5C4033]'>Aviso Legal</h2>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>1. Objeto</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>2. Propiedad Intelectual</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>3. Condiciones de Uso</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>4. Política de Privacidad</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>5. Legislación Aplicable</h3>
        <p className='mb-4 text-gray-800'>
    ...
    ca: (
      <>
        <h2 className='text-xl font-bold mb-4 text-[#5C4033]'>Avís Legal</h2>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>1. Objecte</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>2. Propietat Intel·lectual</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>3. Condicions d'Ús</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>4. Política de Privacitat</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>5. Legislació Aplicable</h3>
        <p className='mb-4 text-gray-800'>
    ...
    en: (
      <>
        <h2 className='text-xl font-bold mb-4 text-[#5C4033]'>Legal Notice</h2>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>1. Purpose</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>2. Intellectual Property</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>3. Terms of Use</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>4. Privacy Policy</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>5. Applicable Legislation</h3>
        <p className='mb-4 text-gray-800'>
    ...
    ar: (
      <>
        <h2 className='text-xl font-bold mb-4 text-[#5C4033]'>إشعار قانوني</h2>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>1. الغرض</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>2. الملكية الفكرية</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>3. شروط الاستخدام</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>4. سياسة الخصوصية</h3>
        <p className='mb-4 text-gray-800'>
        ...
        <h3 className='text-lg font-bold mb-2 text-[#5C4033]'>5. التشريعات المطبقة</h3>
        <p className='mb-4 text-gray-800'>
      ...
      <section className='py-12 bg-[#FAEDCD]' dir={dir}>
        <div className='container mx-auto px-4'>
          <div className='max-w-3xl mx-auto text-center'>
            <h1 className='text-3xl md:text-4xl font-bold text-[#5C4033] mb-6'>{t('legal')}</h1>
