      ...
      <section className="py-12 bg-amber-50" dir={dir}>
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-amber-900 mb-6">{t("contact")}</h1>
      ...
      <section className="py-12 bg-white" dir={dir}>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold text-amber-900 mb-6">{t("contactInfo")}</h2>
              
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-amber-800 mb-2">{t("phone")}</h3>
                <p className="text-gray-700 text-lg">{t("phone")}</p>
              </div>
              
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-amber-800 mb-2">{t("email")}</h3>
                <p className="text-gray-700 text-lg">{t("email")}</p>
              </div>
              
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-amber-800 mb-2">{t("address")}</h3>
                <p className="text-gray-700 text-lg">{t("address")}</p>
              </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-amber-900 mb-6">{t("requestQuote")}</h2>
              <ContactForm />
            </div>
          </div>
        </div>
